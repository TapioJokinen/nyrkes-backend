...
from nyrkes.utils.converters import obj_to_camel_case, to_camel_case
...
class ConvertersTests(TestCase):
    ...
    def test_obj_to_camel_case(self):
        obj_1 = {"dog_dog": 1, "foobar": 1, "cat_cat": 1}
        obj_2 = [
            obj_1,
            {"moo_moo": obj_1},
            {
        ...
        self.assertEqual(obj_to_camel_case(obj_1), {"dogDog": 1, "foobar": 1, "catCat": 1})
        self.assertEqual(
            obj_to_camel_case(obj_2),
            [
                {"dogDog": 1, "foobar": 1, "catCat": 1},
                {"mooMoo": {"dogDog": 1, "foobar": 1, "catCat": 1}},
                {
                    "helloHello": [
                        {
                            "worldWorld": [
                                {"duckDuck": {"dogDog": 1, "foobar": 1, "catCat": 1}},
                                {"duckDuck": {"dogDog": 1, "foobar": 1, "catCat": 1}},
                            ]
                        },
                        {
